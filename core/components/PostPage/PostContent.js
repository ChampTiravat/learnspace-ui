  ...
  render() {
    return (
      <PostWrapper>
        ...
        />
        <br />
        ในป 1913 นักฟสิกสชาวเดนมารกชื่อ นีล บอหร (Niels Bohr) เปนผูหนึ่ง
        พยายามหาคําอธิบายเพิ่มเติมเกี่ยวกับแบบจําลองอะตอมของรัทเธอรฟอรด
        ไดนําทฤษฎีกล ศาสตรควอนตัมมาประยุกตใชในการทดลอง
        เพื่อพัฒนาแบบจําลองอะตอมของรัทเธอรฟอรด อีเล็กตรอนซึ่งมีประจุลบเคลื อ ่
        นที่รอบนิวเคลียสที่มีประจุบวกดวยแรงดึงดูดทางไฟฟาตามกฎ ของคูลอมบ
